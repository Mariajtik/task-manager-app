    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 p-6">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <p className="text-center text-gray-600 mb-8">Organize suas tarefas diárias</p>
                ...
                >
                  ...
                  >
                    {task.completed ? (
                      ...
                      <Circle size={24} className="text-gray-400 group-hover:text-purple-500 transition-colors" />
                    )}
                  </button>
